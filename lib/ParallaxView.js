...
export default class ParallaxView extends Component {
    ...
    renderBackground() {
        ...
        return (
            <Animated.View
                style={[{
                    height: windowHeight + 10, // so children text component can overlap completeley
                    transform: [{
            ...
            >
                <CachedImage style={[styles.background, { height: windowHeight + 10 }, this.props.backgroundStyle]} source={backgroundSource}>
                    {
